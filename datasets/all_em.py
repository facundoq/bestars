import pandas as pd
from . import datasets_by_name_small
from . import base

coefficients=base.coefficients
systems=base.systems

def load(dropna=True, dataset_names=datasets_by_name_small.keys(),exclude=[],verbose=False):
    ...
    for name in dataset_names:
        if name in exclude:
            continue
        x,y,metadata = datasets_by_name_small[name].load(dropna=dropna,verbose=verbose)
